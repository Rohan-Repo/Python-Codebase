...
greeting_msg = input( 'Enter Greeting:' )

# If input is 'Hello ' this space might return 20 so we strip unnecessary starting & ending spaces 
greeting_msg = greeting_msg.strip()

greeting_msg = greeting_msg.lower()

if greeting_msg.startswith('hello'):
    print( '$0' )
elif greeting_msg.startswith('h'):
    print( '$20' )
else:
    print( '$100' )